...
<div class="login-box" style="width: 700px; height: 500px;">
  ...
  <a href="welcome" style="color:#070707"><b>Formulario para Agregar Maestros Materias</b></a>
  </div>
...
<form action="{{url('/MaestrosMaterias')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
{{csrf_field()}}
@include('MaestrosMaterias.form',['Modo'=>'creacionmaestros'])
