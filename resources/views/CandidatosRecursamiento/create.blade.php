...
<form action="{{url('/CandidatosRecursamiento')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
{{csrf_field()}}
@include('CandidatosRecursamiento.form',['Modo'=>'creacioncandidatos'])
