...
<div class="login-box" style="width: 700px; height: 500px;">
  ...
  <a href="home" style="color:#070707"><b>Formulario para Editar alumnos</b></a>
  </div>
...
<form action="{{url('/kardex/' .$kar->id)}}" method="post" enctype="multipart/form-data" >

{{csrf_field()}}
{{method_field('PATCH')}}
@include('kardex.form',['Modo'=>'edicionkardex'])
