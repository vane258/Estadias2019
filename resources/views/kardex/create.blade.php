...
<div class="login-box" style="width: 700px; height: 500px;">
  ...
  <a href="home" style="color:#070707"><b>Formulario para agregar Alumnos</b></a>
  </div>
...
<form action="{{url('/kardex')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
{{csrf_field()}}
@include('kardex.form',['Modo'=>'creacionkardex'])
