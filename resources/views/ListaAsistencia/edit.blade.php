...
<div class="login-box" style="width: 700px; height: 500px;">
  ...
  <a href="welcome" style="color:#070707"><b>Formulario para Editar Alumnos Maestros</b></a>
  </div>
...
<form action="{{url('/ListaAsistencia/' .$lista->id)}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
{{method_field('PATCH')}}
@include('ListaAsistencia.form',['Modo'=>'edicionlista'])
</form>
</div>
<div>
</div>
