...
<div class="col-md-12">
        <div class="card card-plain">
          <div class="card-header card-header-primary" style="background-color:#800080">
            <h4 class="card-title mt-0" style="background-color:#ffffff"> Tabla de alumnos con Becas</h4>
          <!--  este es el input que ayudara a hacer el filtrado y la busqueda en esta vista por nombre
          del alumno-->
            <div class="card-tools">
                  <!--- Aqui esta tu nuevo search :p -->
                  <form action="{{ url('BecasAsignadas') }}" method="GET" class="form:inline pull-right" style="width:250px;heigth:35px"> 
...
<a href="{{url('Ba')}}" class="btn btn-success" style="background:#800080">Reporte</a>
