...
<div class="login-box" style="width: 700px; height: 500px;">
  ...
  <a href="welcome"><b>Formulario para Agregar Aulas</b></a>
  </div>
...
<form action="{{url('/HorarioAulas')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
{{csrf_field()}}
@include('HorarioAulas.form',['Modo'=>'creacionaulas'])
