...
<div class="login-box" style="width: 700px; height: 500px;">
  ...
  <a href="welcome"style="color:#070707"><b>Formulario para Editar aulas</b></a>
  </div>
...
<form action="{{url('/HorarioAulas/' .$aula->id)}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
{{method_field('PATCH')}}
@include('HorarioAulas.form',['Modo'=>'edicionaulas'])
</form>
</div>
</div>
</div>
