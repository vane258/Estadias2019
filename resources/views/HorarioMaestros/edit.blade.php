...
<div class="login-box" style="width: 700px; height: 500px;">
  ...
  <a href="welcome" style="color:#070707"><b>Formulario para Editar Maestros</b></a>
  </div>
...
<form action="{{url('/HorarioMaestros/' .$maestro->id)}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
{{method_field('PATCH')}}
@include('HorarioMaestros.form',['Modo'=>'edicionmaestros'])
</form>
</div>
</div>
</div>
