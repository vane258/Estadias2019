...
<div class="login-box" style="width: 700px; height: 500px;">
  ...
  <a href="welcome" style="color:#070707"><b>Formulario para Agregar Alumnos Maestros</b></a>
  </div>
...
<form action="{{url('/HorarioMaestros')}}" class="form-horizontal" method="post" enctype="multipart/form-data">
{{csrf_field()}}
@include('HorarioMaestros.form',['Modo'=>'creacionmaestros'])
