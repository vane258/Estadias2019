...
<form action="{{url('/ReporteBase/' .$base->id)}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
<!-- se estan pasando los datos mediante el metodo patch-->
{{method_field('PATCH')}}
@include('ReporteBase.form',['Modo'=>'edicionreportebase'])
</form>
</div>
</div>
</div>
