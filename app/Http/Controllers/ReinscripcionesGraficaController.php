...
use App\ReinscripcionGrafica;
use Illuminate\Http\Request;


class ReinscripcionesGraficaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $pastel=\DB::table('reinscripciones')
        ->select(['Nombre_alumno','up'])
...
// desde la bd  a la vista que nosotros tengamos para la misma.
    return view('ReinscripcionesGrafica',['pastel'=>$pastel]);
